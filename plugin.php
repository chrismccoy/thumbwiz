...
if (!class_exists('Thumb_Wiz')) {
    class Thumb_Wiz {
        ...
        public function __construct() {
            ...
            add_action('cleanup_generated_thumbnails', array($this, 'cleanup_generated_thumbnails_handler'));
            add_action('wp_ajax_thumbwiz_save_html5_thumb', array($this, 'save_html5_thumb'));
            add_action('wp_ajax_thumbwiz_redraw_thumbnail_box', array($this, 'redraw_thumbnail_box'));
        }
        ...
        public function save_html5_thumb() {
        ...
        public function redraw_thumbnail_box() {
            check_ajax_referer('thumbwiz-nonce', 'security');
